...
var _ = Describe("DeployAndUpgrade", Ordered, func() {
	...
	When("Upgrading the cluster", Ordered, func() {
		It("should accept the version upgrade", func() {
			...
			SetNestedKey(cluster.Object, "2.18.0", "spec", "general", "version")
			SetNestedKey(cluster.Object, "2.18.0", "spec", "dashboards", "version")
		...
		It("should upgrade the dashboard pod", func() {
			...
			Eventually(func() string {
				...
				return ""
			}, time.Minute*1, time.Second*5).Should(Equal("docker.io/opensearchproject/opensearch-dashboards:2.18.0"))
